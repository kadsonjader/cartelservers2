            ...
            <div class="col-md-9 product-price1">
                ...
                <div class="col-md-7 single-top-in simpleCart_shelfItem">
                    <div class="single-para ">
                        <h4>TeamSpeak Iniciante</h4>
                        <div class="clearfix"> </div>
                    </div>
                    <br>
                    <h2 class="item_price">R$ 5,00/mês</h2>
                    <br>
                    <br>
                    <p>O servidor possui: 10 slots,trafego Ilimitado, Painel de Controle, Firewall fisico</p>
                    <div class="available">
                        <ul>
                            <li>Color
                                <select>
                    ...
                    <ul class="tag-men">
                        ...
                        <li><span>Slots</span>
                            <span class="women1">: 10 SLOTS</span></li>
                    </ul>
                    <form action="checkout.php" method="POST">
                        <input type="hidden" name="produto" value="Teamspeak Iniciante">
