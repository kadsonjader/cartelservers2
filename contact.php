                ...
                <div class="col-md-8 contact-grid">
                    <form action="inserircomentario.php" method="POST">	
                        ...
                        <input type="text" name="email" value="Email" onfocus="this.value = '';" onblur="if (this.value == '') {
                                    this.value = 'Email';}">
                        <input type="text" name="assunto" value="Assunto" onfocus="this.value = '';" onblur="if (this.value == '') {
                                    this.value = 'Assunto';
                                }">

                        <textarea name="mensagem" cols="77" rows="6" value=" " onfocus="this.value = '';" onblur="if (this.value == '') {
                                    this.value = 'Mensagem';
                                }">Mensagem</textarea>
                        <div class="send">
