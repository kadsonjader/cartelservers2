            ...
            <div class="col-md-3 product-price">
                ...
                <div class=" rsidebar span_1_of_left">
                    ...
                    <ul class="menu">
                        ...
                        <li class="item2"><a href="products.php">Jogos</a>
                            <ul class="cute">
                                <li class="subitem1"><a href="single.php">CSGO</a></li>
                                <li class="subitem2"><a href="minecraft.php">Minecraft</a></li>
                                <li class="subitem3"><a href="left4dead.php">lead 4 Dead</a></li>
                            </ul>
                        </li>
            ...
            <div class="col-md-9 product-price1">
                <div class="col-md-5 single-top">	
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="images/servers.png">
                ...
                <div class="col-md-7 single-top-in simpleCart_shelfItem">
                    <div class="single-para ">
                        <h4>Hospedagem Premium</h4>
                        <div class="clearfix"> </div>
                    </div>
                    <br>
                    <h2 class="item_price">R$ 50,00/mês</h2>
                    <br>
                    <br>
                    <p>O servidor possui: ilimitados domínios, ilimitadas contas de email, Ilimitados subdomínios, 20GB de armazenamento, 500GB de tráfego</p>
                    <div class="available">
                        <ul>
                            <li>Color
                                <select>
                    ...
                    <ul class="tag-men">
                        <li><span>SERV</span>
                            <span class="women1">: Hospedagem</span></li>
                        <li><span>PREÇO</span>
                            <span class="women1">: R$50,00</span></li>
                    </ul>
                   <form action="checkout.php" method="POST">
                        <input type="hidden" name="produto" value="Hospedagem premium">
            ...
            <div class="cd-tabs">
                ...
                <ul class="cd-tabs-content">
                    <li data-content="fashion" >
                        <div class="facts">
                            <p >ilimitados domínios, ilimitadas contas de email, Ilimitados subdomínios, 20GB de armazenamento, 500GB de tráfego</p>
