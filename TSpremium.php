            ...
            <div class="col-md-3 product-price">
                ...
                <div class=" rsidebar span_1_of_left">
                    ...
                    <ul class="menu">
                        ...
                        <li class="item2"><a href="#">Hospedagem</a>
                            <ul class="cute">
                                <li class="subitem1"><a href="#">Iniciante</a></li>
                                <li class="subitem2"><a href="#">Intermediario</a></li>
                                <li class="subitem3"><a href="#">Premium</a></li>
                            </ul>
                        </li>
            ...
            <div class="col-md-9 product-price1">
                ...
                <div class="col-md-7 single-top-in simpleCart_shelfItem">
                    ...
                    <form action="checkout.php" method="POST">
                        <input type="hidden" name="produto" value="Teamspeak premium ">
