            ...
            <div class="col-md-9 product-price1">
                <div class="col-md-5 single-top">	
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="images/minecraft_logo_menor.png">
                                <img src="images/minecraft_logo_menor.png" />
                            </li>
                            <li data-thumb="images/Minecraft_logo.png">
                                <img src="images/Minecraft_logo.png" />
                            </li>
                        </ul>
                    </div>
                    <!-- FlexSlider -->
                ...
                <div class="col-md-7 single-top-in simpleCart_shelfItem">
                    ...
                    <br>
                    <br>
                    <p>O servidor possui: Painel de Controle,Admin Ilimitados,servidor de alto desempenho,40 Slots
                        ,suporte garantido</p>
                    <div class="available">
                        <ul>
                            <li>Color
                    ...
                    <ul class="tag-men">
                        <li><span>SERV</span>
                            <span class="women1">: Minecraft,</span></li>
                        <li><span>FREQ</span>
                            <span class="women1">: 40 SLOTS</span></li>
                    </ul>
                    <form action="checkout.php" method="POST">
                        <input type="hidden" name="produto" value="Servidor de Minecraft">
