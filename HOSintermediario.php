            ...
            <div class="col-md-9 product-price1">
                ...
                <div class="col-md-7 single-top-in simpleCart_shelfItem">
                    <div class="single-para ">
                        <h4>Hospedagem Intermediario</h4>
                        <div class="clearfix"> </div>
                    </div>
                    <br>
                    <h2 class="item_price">R$ 25,00/mês</h2>
                    <br>
                    <br>
                    <p>O servidor possui: 50 domínios, 100 contas de email, Ilimitados subdomínios, 10GB de armazenamento, 200GB de tráfego</p>
                    <div class="available">
                        <ul>
                            <li>Color
                                <select>
                    ...
                    <ul class="tag-men">
                        ...
                        <li><span>PREÇO</span>
                            <span class="women1">: R$25,00</span></li>
                    </ul>
                    <form action="checkout.php" method="POST">
                        <input type="hidden" name="produto" value="Hospedagem intermediario">
            ...
            <div class="cd-tabs">
                ...
                <ul class="cd-tabs-content">
                    <li data-content="fashion" >
                        <div class="facts">
                            <p >50 domínios, 100 contas de email, Ilimitados subdomínios, 10GB de armazenamento, 200GB de tráfego</p>
