        ...
        <div class="container">
                    ...
                    <ul class="menu">
                        ...
                        <li class="item2"><a href="products.php">Jogos</a>
                            <ul class="cute">
                                ...
                                <li class="subitem3"><a href="left4dead">lead 4 Dead</a></li>
                            </ul>
                        </li>
            ...
            <div class="col-md-9 product-price1">
                ...
                <div class="col-md-7 single-top-in simpleCart_shelfItem">
                    ...
                    <br>
                    <br>
                    <p>O servidor possui: 5 domínios, 30 contas de email, Ilimitados subdomínios, 1GB de armazenamento, 100GB de tráfego</p>
                    <div class="available">
                        <ul>
                            <li>Color
                                <select>
                    ...
                    <ul class="tag-men">
                        ...
                        <li><span>PREÇO</span>
                            <span class="women1">: R$10,00</span></li>
                    </ul>
                    <form action="checkout.php" method="POST">
                        <input type="hidden" name="produto" value="Hospedagem iniciante">
            ...
            <div class="cd-tabs">
                ...
                <ul class="cd-tabs-content">
                    <li data-content="fashion" >
                        <div class="facts">
                            <p >5 domínios,30 contas de email,Ilimitados subdomínios,1GB de armazenamento, 100GB de tráfego</p>
