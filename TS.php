                ...
                <div class="product-bottom">
                    ...
                    <div class="product-go">
                        <div class=" fashion-grid">
                            <a href="single.php"><img class="img-responsive " src="images/Bf_imagem_menor.png" alt=""></a>
                ...
                <div class=" bottom-product">
                    <div class="col-md-4 bottom-cd simpleCart_shelfItem">
                        <div class="product-at ">
                            <a href="TSiniciante.php"><img class="img-responsive" src="images/TS.png" alt="">
                                <div class="pro-grid">
                                    <span class="buy-in">Compre Agora</span>
                                </div>
                            </a>	
                        </div>
                        <p class="tun">TeamSpeak Iniciante</p>
                        <a href="" class="item_add"><p class="number item_price"><i> </i>R$5.00</p></a>						
                    </div>
                    <div class="col-md-4 bottom-cd simpleCart_shelfItem">
                        <div class="product-at ">
                            <a href="TSintermediario.php"><img class="img-responsive" src="images/TS.png" alt="">
                                <div class="pro-grid">
                                    <span class="buy-in">Compre Agora</span>
                                </div>
                            </a>	
                        </div>
                        <p class="tun">TeamSpeak Intermediario</p>
                        <a href="TSpremium.php" class="item_add"><p class="number item_price"><i> </i>R$10.00</p></a>					</div>
                    <div class="col-md-4 bottom-cd simpleCart_shelfItem">
                        <div class="product-at ">
                            <a href="TSpremium.php"><img class="img-responsive" src="images/TS.png" alt="">
                                <div class="pro-grid">
                                    <span class="buy-in">Compre Agora</span>
                                </div>
                            </a>	
                        </div>
                        <p class="tun">TeamSpeak Premium</p>
                        <a href="TSpremium.php" class="item_add"><p class="number item_price"><i> </i>R$15.00</p></a>					</div>
                    <div class="clearfix"> </div>
                </div>
                <div class=" bottom-product">
                    <div class="col-md-4 bottom-cd simpleCart_shelfItem">
