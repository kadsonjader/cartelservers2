...
<!---->
		<div class="product">
		 ...
		 <ul class="menu">
		<li class="item1"><a href="TS2.php">Jogos</a>
			<ul class="cute">
                            <li class="subitem1"><a href="single2.php">CSGO</a></li>
                            <li class="subitem2"><a href="BF2.php">Battlefield</a></li>
                            <li class="subitem3"><a href="minecraft2.php">Minecraft</a></li>
			</ul>
		</li>
                <li class="item2"><a href="TS2.php">TeamSpeak</a>
			<ul class="cute">
                            <li class="subitem1"><a href="TSiniciante2.php">Iniciante</a></li>
                            <li class="subitem2"><a href="TSintermediario2.php">Intermediario</a></li>
                            <li class="subitem3"><a href="TSpremium2.php">Premium</a></li>
			</ul>
		</li>
	</ul>
					</div>
				...
				<div class="product-bottom">
					...
					<div class="product-go">
						<div class=" fashion-grid">
							...
							<div class="product-go">
						<div class=" fashion-grid">
                                                    <a href="single2.php"><img class="img-responsive " src="images/minecraft_logo_menor.png" alt=""></a>
				...
				<div class=" bottom-product">
					<div class="col-md-4 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="HOSiniciante2.php"><img class="img-responsive" src="images/servers.png" alt="">
							<div class="pro-grid">
										<span class="buy-in">Compre Agora</span>
							</div>
						</a>	
						</div>
						<p class="tun">Hospedagem Iniciante</p>
						<a href="#" class="item_add"><p class="number item_price"><i> </i>R$10.00</p></a>						
					</div>
					<div class="col-md-4 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="HOSintermediario2.php"><img class="img-responsive" src="images/servers.png" alt="">
							<div class="pro-grid">
										<span class="buy-in">Compre Agora</span>
							</div>
						</a>	
						</div>
						<p class="tun">Hospedagem Intermediario</p>
<a href="#" class="item_add"><p class="number item_price"><i> </i>R$25.00</p></a>					</div>
					<div class="col-md-4 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="HOSpremium2.php"><img class="img-responsive" src="images/servers.png" alt="">
							<div class="pro-grid">
										<span class="buy-in">Compre Agora</span>
							</div>
						</a>	
						</div>
						<p class="tun">Hospedagem Premium</p>
<a href="#" class="item_add"><p class="number item_price"><i> </i>R$50.00</p></a>					</div>
					<div class="clearfix"> </div>
				</div>
					<div class=" bottom-product">
					<div class="col-md-4 bottom-cd simpleCart_shelfItem">
