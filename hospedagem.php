...
<!---->
		<div class="product">
		 ...
		 <ul class="menu">
		<li class="item1"><a href="TS.php">Jogos</a>
			<ul class="cute">
				<li class="subitem1"><a href="single.php">CSGO</a></li>
				<li class="subitem2"><a href="BF.php">Battlefield</a></li>
				<li class="subitem3"><a href="minecraft.php">Minecraft</a></li>
			</ul>
		</li>
		<li class="item2"><a href="TS.php">TeamSpeak</a>
			<ul class="cute">
				<li class="subitem1"><a href="TSiniciante.php">Iniciante</a></li>
				<li class="subitem2"><a href="TSintermediario.php">Intermediario</a></li>
				<li class="subitem3"><a href="TSpremium.php">Premium</a></li>
			</ul>
		</li>
	</ul>
					</div>
				...
				<div class="product-bottom">
					...
					<div class="product-go">
						<div class=" fashion-grid">
							...
							<div class="product-go">
						<div class=" fashion-grid">
									<a href="single.php"><img class="img-responsive " src="images/minecraft_logo_menor.png" alt=""></a>
				...
				<div class=" bottom-product">
					<div class="col-md-4 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="HOSiniciante.php"><img class="img-responsive" src="images/servers.png" alt="">
							<div class="pro-grid">
					...
					<div class="col-md-4 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="HOSintermediario.php"><img class="img-responsive" src="images/servers.png" alt="">
							<div class="pro-grid">
										<span class="buy-in">Compre Agora</span>
							</div>
						</a>	
...
<a href="#" class="item_add"><p class="number item_price"><i> </i>R$25.00</p></a>					</div>
					<div class="col-md-4 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="HOSpremium.php"><img class="img-responsive" src="images/servers.png" alt="">
							<div class="pro-grid">
										<span class="buy-in">Compre Agora</span>
							</div>
						</a>	
