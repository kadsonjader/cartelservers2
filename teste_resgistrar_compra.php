            ...
            <div class="col-md-9 product-price1">
                <div class="col-md-5 single-top">	
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="images/csgo.png">
                                <img src="images/csgo.png" />
                            </li>
                            <li data-thumb="images/cs_logo_menor.png">
                                <img src="images/cs_logo_menor.png" />
                            </li>
                            <li data-thumb="images/cs-go.png">
                                <img src="images/cs-go.png" />
                            </li>
                            <li data-thumb="images/tr.png">
                ...
                <div class="col-md-7 single-top-in simpleCart_shelfItem">
                    <div class="single-para ">
                        <h4>Servidor de CSGO</h4>
                        <div class="clearfix"> </div>
                    </div>
                    <br>
                    <h2 class="item_price" >R$ 30,00/mês</h2>
                    <br>
                    <br>
                    <p>O servidor possui: Painel de Controle,Admin Ilimitados,servidor de alto desempenho,128 tickrate,12 Slots
                        EAC Anticheat,suporte garantido</p>
                    <div class="available">
                        <ul>
                            <li>Color
                                <select>
                    ...
                    <ul class="tag-men">
                        <li><span>SERV</span>
                            <span class="women1">: CSGO,</span></li>
                        <li><span>FREQ</span>
                            <span class="women1">: 128 TICK</span></li>
                    </ul><br>
                    <form action="checkout.php" method="POST">
                        <input type="hidden" name="produto" value="CSGO">
            ...
            <div class="cd-tabs">
                <nav>
                    <ul class="cd-tabs-navigation">
                        <li><a data-content="fashion"  href="#">Descrição</a></li>
