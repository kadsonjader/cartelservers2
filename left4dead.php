        ...
        <div class="container">
            ...
            $(function () {
                ...
                <div class="product-bottom">
                    ...
                    <div class="product-go">
                        <div class=" fashion-grid">
                            <a href="#"><img class="img-responsive " src="images/cs_logo_menor.png" alt=""></a>

                        </div>
                        <div class="fashion-grid1">
                            <h6 class="best2"><a href="single.php" ></a>CSGO</h6>

                            <span class=" price-in1">R$ 30,00/mês</span>
                        </div>
            ...
            <div class="col-md-9 product-price1">
                <div class="col-md-5 single-top">	
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="images/Left4Dead.png">
                                <img src="images/Left4Dead.png" />
                            </li>
                            <li data-thumb="images/Left4Dead 2_logo.png">
                                <img src="images/Left4Dead 2_logo.png" />
                            </li>
                        </ul>
                    </div>
                    <!-- FlexSlider -->
            ...
            $(window).load(function () {
                ...
                <div class="col-md-7 single-top-in simpleCart_shelfItem">
                    <div class="single-para ">
                        <h4>Servidor de Left 4 Dead</h4>
                        <div class="clearfix"> </div>
                    </div>
                    <br>
                    <h2 class="item_price">R$ 70,00/mês</h2>
                    <br>
                    <br>
                    <p>O servidor possui: Painel de Controle,Admin Ilimitados,servidor de alto desempenho
                        ,suporte garantido</p>
                    <div class="available">
                        <ul>
                            <li>Color
                                <select>
                                    <option>Com painel de controle</option>
                                    <option>Sem painel de controle</option>
                                </select></li>
                            <div class="clearfix"> </div>
                        </ul>
                    </div>
                    <ul class="tag-men">
                        <li><span>SERV</span>
                            <span class="women1">: left 4 dead,</span></li>
                        <li><span>PAINEL</span>
                            <span class="women1">: SIM</span></li>
                    </ul>
                    <form action="checkout.php" method="POST">
                        <input type="hidden" name="produto" value="Servidor de left 4 dead">
                        <input type="hidden" name="valor" value="70,00">
