                ...
                <div class="product-bottom">
                    ...
                    <div class="product-go">
                        ...
                        <div class=" fashion-grid1">
                            <h6 class="best2"><a href="BF.php">CSGO</a></h6>
            ...
            <div class="col-md-9 product-price1">
                <div class="col-md-5 single-top">	
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="images/BF_imagem_menor.png">
                                <img src="images/BF_imagem_menor.png" />
                            </li>
                            <li data-thumb="images/bf_logo_menor.png">
                                <img src="images/bf_logo_menor.png" />
                            </li>
                        </ul>
                    </div>
                    <!-- FlexSlider -->
                ...
                <div class="col-md-7 single-top-in simpleCart_shelfItem">
                    <div class="single-para ">
                        <h4>Servidor de Battlefield</h4>
                        <div class="clearfix"> </div>
                    </div>
                    <br>
                    <h2 class="item_price">R$ 145,00/mês</h2>
                    <br>
                    <br>
                    <p>O servidor possui: Painel de Controle,Admin Ilimitados,servidor de alto desempenho,60 tickrate,32 Slots
                        ,suporte garantido</p>
                    <div class="available">
                        <ul>
                            <li>Color
                    ...
                    <ul class="tag-men">
                        <li><span>SERV</span>
                            <span class="women1">: BF,</span></li>
                        <li><span>FREQ</span>
                            <span class="women1">: 60 TICK</span></li>
                    </ul>
                    <form action="checkout.php" method="POST">
                        <input type="hidden" name="produto" value="Servidor de Battlefield">
                        <input type="hidden" name="valor" value="145,00">
